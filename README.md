# MetricsForAll
Metrics for all es una aplicación para análisis estadístico avanzado usando información proporcionada por la FEB y distintas federaciones regionales en España.
...
Añadir nuevas federaciones resulta un cambio complejo que se abordará en fases posteriores debido a que la estructura de la información difiere de la FEB y, por tanto, habría que aplicar una transformación a estos datos de origen para poder usar los mismos métodos de análsisi.
